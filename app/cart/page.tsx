    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 mt-12">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-16">
                {/* STEPS */}
                <div className="w-full lg:w-7/10 flex flex-col gap-8 shadow-lg border border-gray-100 rounded-lg p-8">
                    {
                        activeStep === 1 ?
                            (
                                cart.map((item) => (
                                    ...
                                    <div className="flex items-center justify-between" key={item.id}>
                                        ...
                                        {/* DELETE BUTTON */}
                                        <button onClick={() => removeFromCart(item)} className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-200 text-red-400 flex items-center justify-center">
                ...
                <div className="w-full lg:w-5/10 flex flex-col gap-8 shadow-lg border border-gray-100 rounded-lg p-8 h-max ">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex justify-between text-sm ">
                            <p className="text-sm text-gray-600 font-bold">Discount(10%)</p>
                            <p className="font-medium">-$10</p>
                        </div>
                        <div className="flex justify-between text-sm ">
                            <p className="text-sm text-gray-600 font-bold">Shipping Fee</p>
                            <p className="font-medium">$10</p>
                        </div>
                    </div>
